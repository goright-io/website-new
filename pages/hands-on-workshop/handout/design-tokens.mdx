...
Reuse the defined text styles, colors (Background, On background, primary). Potentially you can add more styles, such a secondary or support colors (Success, Info, Error).
