...
This is a large task, that we are going to work on the second day. We split it
...
Overall you have 1 hour 30 minutes to prepare the 1st version of your library for release. Take components and spacing tokens from the night pull requests, and call us to join you in breakout room if you have any questions. 